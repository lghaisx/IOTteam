...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;
        <span><a href="${pageContext.request.contextPath}/Oform-excel3.action?oform.bname=${requestScope.huiyuan2[0].bname}"  class="btn btn-success radius"><i class="Hui-iconfont">&#xe644;</i> 导出表格</a></span>
