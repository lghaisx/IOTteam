...
<body>
<form class="vali_form" action="Task-update.action" method="post" name="example">
    <input type="hidden" name="id" value="${requestScope.task.id}">
    <div><h5 class="h1"><span>*</span>作业标题:</h5><input type="text" class="ip1" name="title" datatype="*" errormsg="请输入文章标题" value="${requestScope.task.title}"/></div>
    <div><h5 class="h4"><span>*</span>作业内容:</h5>
        <textarea id="editor" name="cont" cols="100" rows="8">
