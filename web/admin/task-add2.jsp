...
<head lang="en">
    ...
    <script>
        KindEditor.ready(function(K) {
            var editor1 = K.create('textarea[name="question"]', {
...
%>
<form class="vali_form" action="Task-question.action" method="post" name="example">
    <input type="hidden" name="id" value="<%=id%>">
    <div><h5 class="h4"><span>*</span>作业答案:</h5>
        <textarea id="editor" name="question" cols="100" rows="8"></textarea>
    </div>
    <input type="submit" value="提交答案" id="sub">
