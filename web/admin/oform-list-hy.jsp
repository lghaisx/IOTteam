...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;
        <span><a href="${pageContext.request.contextPath}/Oform-excel2.action?oform.oname=${requestScope.huiyuan2[0].oname}"  class="btn btn-success radius"><i class="Hui-iconfont">&#xe644;</i> 导出表格</a></span>
        <span class="r">共有数据：<strong>
        <c:if test="${requestScope.huiyuan2!=null}">
            ${fn:length(requestScope.huiyuan2)}
        </c:if>
	</strong> 条</span> </div>
    <c:if test="${requestScope.huiyuan2!=null}">
        <form action="${pageContext.request.contextPath}/Oform-dels.action" method="post" id="for1">
            <table class="table table-border table-bordered table-bg">
                ...
                <tbody>
                <c:forEach items="${requestScope.huiyuan2}" var="code" varStatus="num">
                    <tr class="text-c">
