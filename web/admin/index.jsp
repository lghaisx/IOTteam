...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="javascript:;">物联网协会后台管理系统</a>
		...
		<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
			<ul class="cl">
				...
				<li class="dropDown dropDown_hover">
					<a href="#" class="dropDown_A">${sessionScope.login.username}<i class="Hui-iconfont">&#xe6d5;</i></a>
					<ul class="dropDown-menu menu radius box-shadow">
						<li><a href="${pageContext.request.contextPath}/Account-exit.action">切换账户</a></li>
						<li><a href="${pageContext.request.contextPath}/Account-exit.action">退出</a></li>
				</ul>
			</li>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a data-href="Production-query.action" data-title="作品管理" href="javascript:void(0)">作品管理</a></li>
			</ul>
		</dd>
	</dl>
		...
		<dl id="menu-member">
			...
			<dd>
				<ul>
					<li><a data-href="Member-query.action" data-title="成员列表" href="javascript:;">成员列表</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-member">
			...
			<dd>
				<ul>
					<li><a data-href="Task-query.action" data-title="作业列表" href="javascript:;">作业列表</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					...
					<li><a data-href="Account-query.action" data-title="管理员列表" href="javascript:void(0)">管理员列表</a></li>
			</ul>
		</dd>
	</dl>
		<%--<dl id="menu-tongji">--%>
			<%--<dt><i class="Hui-iconfont">&#xe61a;</i>二维码管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>--%>
			<%--<dd>--%>
				<%--<ul>--%>
					<%--<li><a data-href="Oform-query.action" data-title="消费统计" href="javascript:;">消费统计</a></li>--%>
				<%--</ul>--%>
			<%--</dd>--%>
		<%--</dl>--%>
		<%--<dl id="menu-system">--%>
	...
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active">
					<span title="我的桌面" data-href="${pageContext.request.contextPath}/admin/welcome.html">我的桌面</span>
					<em></em></li>
		</ul>
	</div>
