...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		...
		<span class="l">
			...
			<a href="javascript:;" onclick="member_add('添加用户','${pageContext.request.contextPath}/admin/member-add.html','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加用户</a>
			<%--<a href="javascript:;"  class="btn btn-primary radius" id="import"><i class="Hui-iconfont">&#xe600;</i> 批量添加</a>--%>
		</span>
		<span class="r">共有数据：<strong>
        <c:if test="${requestScope.members!=null}">
			${fn:length(requestScope.members)}
		</c:if>
	</strong> 条</span> </div>
	<div class="mt-20">
		<c:if test="${requestScope.members!=null}">
			<form action="${pageContext.request.contextPath}/Member-dels.action" method="post" id="for1">
				<table class="table table-border table-bordered table-hover table-bg table-sort">
					...
					<tbody>
					<c:forEach items="${requestScope.members}" var="older" varStatus="num">
						<tr class="text-c">
							...
							<td class="td-manage">
								...
								<%--</c:if>--%>
								<a title="编辑" href="javascript:;" onclick="member_edit('编辑','Member-get.action?id='+${older.id},'4','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>  <a title="删除" href="javascript:;" onclick="member_del(this,${older.id})" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>
							</td>
						</tr>
					</c:forEach>
					</tbody>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/jquery.ocupload-1.1.2.js"></script> <!--/_footer 作为公共模版分离出去-->
